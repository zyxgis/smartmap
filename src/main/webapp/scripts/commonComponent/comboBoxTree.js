 ...
 *下拉树类(Jelly)
 */
Ext.define('com.summit.commons.TreeCombox', {
...
//        var selectedStr = record.get(this.valueField || 'id');
//        if("root" == selectedStr){
//        	selectedStr = "";
//        }else{
//        	var thirdChr = selectedStr.substr(2,1);
//        	var fouthChr = selectedStr.substr(3,1);
//        	
//        	var fifthChr = selectedStr.substr(4,1);
//        	var sixthChr = selectedStr.substr(5,1);
//        	if(thirdChr == 0 && fouthChr == 0 && fifthChr == 0 && sixthChr == 0){
//        		selectedStr = selectedStr.substring(0, 2) + '%';
//        	}else if( (thirdChr != 0 || fouthChr != 0) && (fifthChr == 0 && sixthChr == 0) ){
//        		selectedStr = selectedStr.substring(0, 4) + '%';
//        	}
//        }
//        me.setValue("root" == record.get(this.valueField || 'id') ? "" : record.get(this.valueField || 'id'));
